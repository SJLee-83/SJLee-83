...
> 어르신을 위한 무인 이동 서비스를 소형 RC카(Jetson Orin Nano)로 구현한 SSAFY 공통프로젝트로, 실내 5×3m 트랙에서 호출·배차·주행·도착 보고까지 사람이 개입하지 않고 수행합니다. 시연 당일 완주 3회(점검 주행 2회, 본 시연 1회), 본 시연 도착 오차 12.2cm와 8.7cm를 기록했습니다.
