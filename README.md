# 👋 안녕하세요, AI 기술로 더 나은 서비스를 만드는 개발자 이승재입니다.

<!-- 
2~3줄로 자신을 어필하는 소개 문구를 작성해보세요. 
어떤 기술에 관심이 많고, 어떤 개발자로 성장하고 싶은지 보여주면 좋습니다. 
-->
저는 사용자의 복잡한 문제를 해결하는 것에 흥미를 느끼며, 특히 Python과 AI 기술을 활용한 백엔드 시스템 설계에 깊은 관심을 가지고 있습니다. 클린 코드와 테스트 가능한 아키텍처를 지향하며, 동료와 함께 성장하는 개발 문화를 좋아합니다.
