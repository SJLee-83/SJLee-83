...
산업공학에서 데이터 분석과 시스템 최적화를 공부하다 소프트웨어 개발로 영역을 넓혔습니다. RAG·LLM을 실제 제품에 적용하는 일에 관심이 있고, **측정한 것과 아직 측정하지 않은 것을 구분해 정직하게 만드는 것**을 중요하게 생각합니다.
...
### 4. C-Care — VDT 증후군 예방 모니터링 (졸업 프로젝트)

> 웹캠으로 사용자와 모니터 사이 거리를 분류해 자세 교정을 유도하는 서비스입니다.
